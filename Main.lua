...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Remove Notification", Default = false })
...
Tabs.Setting:AddButton({
    ...
    function FPSBooster()
        ...
        local SKill = Tabs.Setting:AddSection("Mastery Settings")
