...
function CheckLevel() 
    ...
    elseif World3 then
        ...
        elseif Level == 2575 or Level <= 2600 then
            Mon = "Skull Slayer"
            LevelQuest = 2
            NameQuest = "TikiQuest3"
...
function Hop()
    ...
    function Tween(Pos)
        if game.Players.LocalPlayer.Character.Humanoid.Health > 0 and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            ...
            scibidi = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.PartTele, TweenInfo.new(Distance / getgenv().TweenSpeed, Enum.EasingStyle.Linear),{CFrame = Pos})
            scibidi:Play()
        end
    end
    ...
    function CheckBalo(Name)
        ...
        local Allfarm = Tabs.Main:AddSection("Misc Farm")
